...
bodymovin.loadAnimation({
    ...
    loop: false,
    autoplay: true,
    path: 'assets/animation/pizza_pie.json',
})
...
const pizza_anim = bodymovin.loadAnimation({
    ...
    loop: false,
    autoplay: false,
    path: 'assets/animation/pizza_fall.json',
    frame: 0
})
...
function onDOMLoaded(e) {
    ...
    .fromTo(origin, 10, { opacity: 0, x: '50px' }, { opacity: 1, x: '0px', ease: Power2.easeInOut })
        ...
        .fromTo(isareal_map, 10, { x: '-50px', opacity: 0 }, { x: '0px', opacity: 1, ease: Power2.easeInOut }, "-=10")
        .fromTo(matzah, 10, { opacity: 0 }, { opacity: 1, ease: Power2.easeInOut }, "+=20")


    .fromTo(p2, 10, { opacity: 0 }, { opacity: 1, ease: Power2.easeInOut })
        .fromTo(p2, 10, { x: '-50px' }, { x: '0px', ease: Power2.easeInOut }, "-=10")
        .fromTo(europe_map, 10, { x: '-50px', opacity: 0 }, { x: '0px', opacity: 1, ease: Power2.easeInOut }, "-=10")
        .fromTo(europe, 10, { opacity: 0 }, { opacity: 1, ease: Power2.easeInOut }, "+=20")

    .fromTo(p3, 10, { opacity: 0 }, { opacity: 1, ease: Power2.easeInOut })
        .fromTo(p3, 10, { x: '50px' }, { x: '0px', ease: Power2.easeInOut }, "-=10")
        .fromTo(asia_map, 10, { x: '-50px', opacity: 0 }, { x: '0px', opacity: 1, ease: Power2.easeInOut }, "-=10")
        .fromTo(asia, 10, { opacity: 0 }, { opacity: 1, ease: Power2.easeInOut }, "+=20")
...
const rocket = bodymovin.loadAnimation({
    ...
    loop: true,
    autoplay: false,
    path: 'assets/animation/rocket.json',
    frame: 0
})
...
const computer_anim = bodymovin.loadAnimation({
    ...
    loop: true,
    autoplay: false,
    path: 'assets/animation/computer.json',
    frame: 0
})
...
const scale_illustration = bodymovin.loadAnimation({
    ...
    loop: false,
    autoplay: false,
    path: 'assets/animation/pepperoni_scale.json',
    frame: 0
})
...
const US_map = bodymovin.loadAnimation({
    ...
    loop: false,
    autoplay: false,
    path: 'assets/animation/US_map.json',
    frame: 0
})
